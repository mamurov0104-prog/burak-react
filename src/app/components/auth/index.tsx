...
interface AuthenticationModalProps {
  signupOpen: boolean; // proporty state
  loginOpen: boolean; // proporty state
...
export default function AuthenticationModal(props: AuthenticationModalProps) {
  ...
  const handleSignupRequest = async () => {
    try {
      ...
      const isFulFill = // frontendga daxldor validation mantiq
  ...
  return (
    <div>
      <Modal
        ...
        open={signupOpen}
        onClose={handleSignupClose} // signup oynasi chiqqanda tashqariga bosilsa hidden bo'ladi
